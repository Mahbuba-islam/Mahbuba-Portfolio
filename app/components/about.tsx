          ...
          <ul className="grid gap-4 sm:grid-cols-2">
            {HIGHLIGHTS.map((h, i) => (
              ...
              >
                ...
                <div className="grid h-9 w-9 place-items-center rounded-lg bg-linear-to-br from-indigo-500/20 to-purple-500/20 text-indigo-900 dark:text-indigo-200 ring-1 ring-indigo-400/30">
